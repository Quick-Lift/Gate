...
//                startActivity(new Intent(Payment.this,EditProfile.class));
//            }
//        });
//
//        updatenavbar();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_rides) {
            intent = new Intent(Payment.this, CustomerRides.class);
            startActivity(intent);
        } else if (id == R.id.nav_settings) {
            startActivity(new Intent(Payment.this,Settings.class));
            finish();
        } else if (id == R.id.nav_drive_with_us) {
            startActivity(new Intent(Payment.this,DriveWithUs.class));
            finish();
            ...
            startActivity(new Intent(Payment.this,OffersActivity.class));
            finish();
        } else if (id == R.id.nav_payment) {

        } else if (id == R.id.nav_support) {
            startActivity(new Intent(Payment.this,Support.class));
            finish();
